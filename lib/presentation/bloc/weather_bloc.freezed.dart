...
mixin _$WeatherState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<WeatherEntity> weather) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<WeatherEntity> weather)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<WeatherEntity> weather});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required final List<WeatherEntity> weather})
      : _weather = weather;
...
abstract class _Loaded implements WeatherState {
  const factory _Loaded({required final List<WeatherEntity> weather}) =
      _$LoadedImpl;
